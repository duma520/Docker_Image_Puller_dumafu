...
# ----------------- 配置参数 -----------------
CONNECT_TIMEOUT = 600      # 连接超时10分钟
READ_TIMEOUT = 7200        # 读取超时2小时
MAX_RETRIES = 20           # 最大重试次数
RETRY_BACKOFF_BASE = 5     # 指数退避基数
MAX_THREADS = 20           # 最大线程数

# ----------------- 性能配置 -----------------
INIT_CHUNK_SIZE = 256 * 1024     # 256KB初始块
LARGE_FILE_THRESHOLD = 500 * 1024 * 1024  # 500MB大文件阈值
LARGE_CHUNK_SIZE = 2 * 1024 * 1024       # 2MB大文件块
